...
public class MMTViewDecl_impl extends ASTWrapperPsiElement implements MMTViewDecl {

  public MMTViewDecl_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitViewDecl(this);
  }
  ...
  @Override
  @Nullable
  public MMTViewConstant getViewConstant() {
    return findChildByClass(MMTViewConstant.class);
  }
