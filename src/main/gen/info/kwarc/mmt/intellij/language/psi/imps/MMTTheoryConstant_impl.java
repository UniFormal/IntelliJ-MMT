...
public class MMTTheoryConstant_impl extends ASTWrapperPsiElement implements MMTTheoryConstant {

  public MMTTheoryConstant_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitTheoryConstant(this);
  }
  ...
  @Override
  @NotNull
  public List<MMTComponent> getComponentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MMTComponent.class);
  }
