...
public class MMTNotComp_impl extends ASTWrapperPsiElement implements MMTNotComp {

  public MMTNotComp_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitNotComp(this);
  }
  ...
  @Override
  @Nullable
  public MMTPrec getPrec() {
    return findChildByClass(MMTPrec.class);
  }
