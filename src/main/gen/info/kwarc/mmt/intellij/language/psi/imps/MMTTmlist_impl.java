...
public class MMTTmlist_impl extends ASTWrapperPsiElement implements MMTTmlist {

  public MMTTmlist_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitTmlist(this);
  }
  ...
  @Override
  @NotNull
  public List<MMTTerm> getTermList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MMTTerm.class);
  }
