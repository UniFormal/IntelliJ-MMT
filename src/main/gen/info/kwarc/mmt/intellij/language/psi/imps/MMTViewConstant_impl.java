...
public class MMTViewConstant_impl extends ASTWrapperPsiElement implements MMTViewConstant {

  public MMTViewConstant_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitViewConstant(this);
  }
