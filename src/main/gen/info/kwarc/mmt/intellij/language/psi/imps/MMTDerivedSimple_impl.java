...
public class MMTDerivedSimple_impl extends ASTWrapperPsiElement implements MMTDerivedSimple {

  public MMTDerivedSimple_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitDerivedSimple(this);
  }
