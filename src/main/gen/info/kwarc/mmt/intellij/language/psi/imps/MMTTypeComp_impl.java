...
public class MMTTypeComp_impl extends ASTWrapperPsiElement implements MMTTypeComp {

  public MMTTypeComp_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitTypeComp(this);
  }
