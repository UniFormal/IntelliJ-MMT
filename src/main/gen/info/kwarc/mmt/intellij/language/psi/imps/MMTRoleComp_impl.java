...
public class MMTRoleComp_impl extends ASTWrapperPsiElement implements MMTRoleComp {

  public MMTRoleComp_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitRoleComp(this);
  }
