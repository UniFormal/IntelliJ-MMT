...
public class MMTModuleScopedComment_impl extends ASTWrapperPsiElement implements MMTModuleScopedComment {

  public MMTModuleScopedComment_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitModuleScopedComment(this);
  }
