...
public class MMTObjComment_impl extends ASTWrapperPsiElement implements MMTObjComment {

  public MMTObjComment_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitObjComment(this);
  }
