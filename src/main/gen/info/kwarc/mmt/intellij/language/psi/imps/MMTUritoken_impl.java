...
public class MMTUritoken_impl extends ASTWrapperPsiElement implements MMTUritoken {

  public MMTUritoken_impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MMTVisitor visitor) {
    visitor.visitUritoken(this);
  }
  ...
  @Override
  @Nullable
  public MMTKeywrd getKeywrd() {
    return findChildByClass(MMTKeywrd.class);
  }
